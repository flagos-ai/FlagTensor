...
from flagtensor.config import DEFAULT_BENCHMARK_DTYPES, DEFAULT_TANH_BENCHMARK_SHAPES
...
try:
    from flagtensor.cutensor import CuTensorTanh as _BaselineClass
except ImportError:
    _BaselineClass = None
try:
    ...
    def __init__(self):
        super().__init__(
            ...
            config=BenchmarkConfig(
                ...
                shapes=tuple(DEFAULT_TANH_BENCHMARK_SHAPES),
            ),
        )
        self.baselines = {}
