...
from flagtensor.config import DEFAULT_BENCHMARK_DTYPES, DEFAULT_ASINH_BENCHMARK_SHAPES
...
try:
    from flagtensor.cutensor import CuTensorAsinh as _BaselineClass
except ImportError:
    _BaselineClass = None
try:
    ...
    def __init__(self):
        super().__init__(
            ...
            config=BenchmarkConfig(
                ...
                shapes=tuple(DEFAULT_ASINH_BENCHMARK_SHAPES),
            ),
        )
        self.baselines = {}
