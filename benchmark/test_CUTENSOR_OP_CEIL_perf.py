...
from flagtensor.config import DEFAULT_BENCHMARK_DTYPES, DEFAULT_CEIL_BENCHMARK_SHAPES
...
try:
    from flagtensor.cutensor import CuTensorCeil as _BaselineClass
except ImportError:
    _BaselineClass = None
try:
    ...
    def __init__(self):
        super().__init__(
            ...
            config=BenchmarkConfig(
                ...
                shapes=tuple(DEFAULT_CEIL_BENCHMARK_SHAPES),
            ),
        )
        self.baselines = {}
