...
from flagtensor.config import DEFAULT_BENCHMARK_DTYPES, DEFAULT_ATAN_BENCHMARK_SHAPES
...
try:
    from flagtensor.cutensor import CuTensorAtan as _BaselineClass
except ImportError:
    _BaselineClass = None
try:
