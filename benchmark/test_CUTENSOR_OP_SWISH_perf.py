...
from flagtensor.config import DEFAULT_BENCHMARK_DTYPES, DEFAULT_SWISH_BENCHMARK_SHAPES
...
try:
    from flagtensor.cutensor import CuTensorSwish as _BaselineClass
except ImportError:
    _BaselineClass = None
try:
