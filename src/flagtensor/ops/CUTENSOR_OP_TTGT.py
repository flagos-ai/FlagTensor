...
from flagtensor.cutensor import ttgt as cutensor_ttgt
...
def ttgt(a, b, *, c=None, alpha=1.0, beta=0.0, mode_a=None, mode_b=None, mode_c=None, mode_d=None, out=None):
    if _supports_triton_ttgt(a, b, c, mode_a, mode_b, mode_c, mode_d):
        ...
        return _launch_gett_like_kernel(a, b, c, out, alpha, beta, trans_a=True, trans_b=True)
    return cutensor_ttgt(
        a,
        b,
        c=c,
        alpha=alpha,
