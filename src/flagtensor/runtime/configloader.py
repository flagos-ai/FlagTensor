...
class ConfigLoader(object):
    ...
    def get_heuristics_config(self, op_name):
        ...
        if self.vendor_heuristics_config and op_name in self.vendor_heuristics_config:
            return self.vendor_heuristics_config[op_name]
        if self.default_heuristics_config and op_name in self.default_heuristics_config:
    ...
    def _gen_impl(self, gen_config, iteration_plan, std_config):
        all_configs = []
    ...
    def to_gen_config(self, gen_config):
        ...
        return self._gen_impl(gen_config, iteration_plan, current_config)
