...
"""PPU-native baseline classes for FlagTensor benchmarks.
...
* **PyTorch native ops DO use vendor-optimised kernels.** Profiling
...
PPU-native baseline. This is NOT a "fallback" — it is the vendor-supplied
optimised path on PPU, exactly analogous to how cuTensor is the
vendor-supplied baseline on NVIDIA.
...
def elementwise_trinary(
    ...
    """PPU-native elementwise trinary function (mirror of cutensor.elementwise_trinary)."""
