...
def pytest_configure(config):
    ...
    config.addinivalue_line("markers", "block_sparse_tensor_contraction: weekly compatibility marker")
    ...
    config.addinivalue_line("markers", "gett: weekly compatibility marker")
    ...
    config.addinivalue_line("markers", "tensor_contraction_trinary: weekly compatibility marker")
    config.addinivalue_line("markers", "tgett: weekly compatibility marker")
    config.addinivalue_line("markers", "trinary: weekly compatibility marker")
    config.addinivalue_line("markers", "ttgt: weekly compatibility marker")
    config.addinivalue_line("markers", "trinary_generic: weekly compatibility marker")
